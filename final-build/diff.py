...
def diff_snapshots(analysis_id: str, old: Snapshot, new: Snapshot) -> SemanticDiff:
    ...
    # Positive observations remain usable under partial enrichment: if a relation
    # was actually returned we can safely record the addition. Absence, however,
    # is not evidence of deletion unless the relation plane was complete.
